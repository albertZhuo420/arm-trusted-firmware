...
In the TF-A source directory (sources/*/tf-a-stm32mp-v2.8.6-stm32mp-r1-r0),
you have one TF-A source tarball, the patches and one Makefile:
   - tf-a-stm32mp-v2.8.6-stm32mp-r1-r0.tar.xz
   - 00*.patch
   - Makefile.sdk
...
---------------------------------------------------------------
    ...
    $ git checkout -b WORKING lts-v2.8.6
